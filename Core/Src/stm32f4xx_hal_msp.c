...
void HAL_I2S_MspInit(I2S_HandleTypeDef* hi2s)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = MIC_WS_Pin|MIC_CK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_I2S_MspDeInit(I2S_HandleTypeDef* hi2s)
{
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, MIC_WS_Pin|MIC_CK_Pin);
...
void HAL_SD_MspInit(SD_HandleTypeDef* hsd)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = SD_D0_Pin|SD_D3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF12_SDIO;
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspInit 0 */
    ...
    PA10     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = LPS_SCK_Pin|LPS_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    GPIO_InitStruct.Pin = LPS_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(LPS_MOSI_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PA10     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, LPS_SCK_Pin|LPS_MISO_Pin);

    HAL_GPIO_DeInit(LPS_MOSI_GPIO_Port, LPS_MOSI_Pin);
